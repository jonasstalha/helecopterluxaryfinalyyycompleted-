...
// Example static helicopter data with fixed images for each package
const staticHelicopters: Helicopter[] = [
  ...
  },
  {
    ...
    images: [img12, img17, img6, img7, img8], // Fixed images with img12 as primary
    features: [
      'Private Flight',
      'Roses & Chocolates',
      'Sunset Option',
  ...
  },
  {
    ...
    images: [img13, img9, img10, img11], // Fixed images with img13 as primary
    features: [
      'VIP Lounge access',
  ...
  },
  {
    ...
    images: [img3, img14, img1, img2], // Fixed images with img3 as primary
    features: [
      'Canyon Landing',
      'Champagne Toast',
      'Scenic Flight',
  ...
  },
  {
    ...
    images: [img17, img16, img5, img4, img6], // Fixed images with img17 as primary
    features: [
      'Private Flight',
  ...
  },
  {
    ...
    images: [img16, img7, img8, img9, img11], // Fixed images with img16 as primary
    features: [
      'Roses & Cake',
      'Champagne',
      'Custom Playlist',
...
export const HelicopterListPage: React.FC = () => {
  ...
  useEffect(() => {
    FacebookPixelTracker.trackPageView('Helicopter List');
  }, []);
  ...
  useEffect(() => {
    ...
    const filtered = helicopters.filter(helicopter => {
      const matchesSearch =
    ...
    if (searchTerm && searchTerm.length > 2) {
      FacebookPixelTracker.trackSearch(searchTerm, filtered.length);
    }
