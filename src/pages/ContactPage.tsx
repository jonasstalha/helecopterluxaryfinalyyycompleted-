...
const contactInfo = [
  ...
  },
  {
    icon: Phone,
    title: 'Call Us',
    details: ['+1 (702) 815-8697', '24/7 Customer Support +1 (702) 815-8697'],
    action: 'Call Now'
  },
  {
    icon: MessageSquare,
    title: 'WhatsApp Us',
    details: ['+44 7939 956301', 'Instant messaging support'],
...
export const ContactPage: React.FC = () => {
  ...
  useEffect(() => {
    FacebookPixelTracker.trackPageView('Contact');
  }, []);
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      FacebookPixelTracker.trackContact({
        name: data.name,
        email: data.email,
        phone: data.phone,
      ...
      await whatsappService.sendContactFormToWhatsApp(data);
      
      // Simulate additional form submission (Firebase/API call if needed)
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      toast.success('Message sent successfully! Your inquiry has been forwarded to our WhatsApp and email. We\'ll get back to you within 2 hours.');
      reset();
    } catch (error) {
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <Button 
                  ...
                  className="w-full"
                  onClick={() => {
                    if (info.title === 'WhatsApp Us') {
                      whatsappService.sendQuickNotification('Contact Page Inquiry', 'contact@helicopterluxury.com');
                    }
                  }}
                >
                  {info.action}
            ...
            >
              ...
              <div className="bg-navy-900 text-white rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <a
                    href="tel:+17028158697"
                    onClick={() => FacebookPixelTracker.trackPhoneCall()}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-300">+1 (702) 815-8697</p>
                    </div>
                  </a>
                  <a
                    href="mailto:vanguardhelicopter@gmail.com"
                    onClick={() => FacebookPixelTracker.trackEmailClick()}
                    className="flex items-center p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors duration-200"
                  >
                  ...
                  <button
                    onClick={() => whatsappService.sendQuickNotification('Quick Contact', 'emergency@helicopterluxury.com')}
                    className="flex items-center p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors duration-200 w-full text-left"
                  >
                    <MessageSquare className="w-6 h-6 text-gold-400 mr-3" />
                    <div>
                      <p className="font-semibold">WhatsApp Support</p>
                      <p className="text-sm text-gray-300">+44 7939 956301</p>
                    </div>
                  </button>
                </div>
              </div>
